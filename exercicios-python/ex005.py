...
#como o pedido do desafio é um pedido simples de apenas retornar um antecessor e um sucessor existe uma forma mais compacta de se resolver tambem que é assim:
